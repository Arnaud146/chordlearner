...
export default function ErrorPage({ error, reset }: ErrorPageProps) {
  ...
  return (
    <section className="mx-auto max-w-2xl space-y-4 py-16 text-center">
      <p className="text-sm font-semibold uppercase tracking-wide text-red-700">Erreur applicative</p>
      <h1 className="text-3xl font-bold text-zinc-900">Quelque chose s&apos;est mal passe</h1>
      <p className="text-zinc-700">
        Une erreur inattendue est survenue. Tu peux reessayer ou revenir a l&apos;accueil.
      </p>
